...
// 🔥 Упрощённые темы без profileMatch (чтобы не было ошибки never)
...
// 🔥 Простая функция без сложной типизации
...
export function createWagmiConfig(){
  return createConfig({
    ...
    connectors:[
      ...
      walletConnect({projectId:WALLETCONNECT_PROJECT_ID,showQrModal:true,metadata:{name:APP_NAME,description:APP_DESCRIPTION,url:'https://c4c-chess.vercel.app',icons:[]}}),
    ],
