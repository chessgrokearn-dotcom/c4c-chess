...
export const BSC_CHAIN_ID = 56 as const; // 🔥 ДОБАВЛЕНО
...
export const STAKE_CONFIG = { MIN: STAKE_MIN, MAX: STAKE_MAX, STEP: STAKE_STEP, OPTIONS: STAKE_OPTIONS } as const; // 🔥 ДОБАВЛЕНО

export const TIME_OPTIONS = [300, 600, 900] as const;
export const TIME_CONFIG = { OPTIONS: TIME_OPTIONS, DEFAULT: 600 } as const; // 🔥 ДОБАВЛЕНО
