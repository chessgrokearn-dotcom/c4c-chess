/**
 * ABI для C4C Game контракта
 * Контракт адрес: 0xCf5E5d01ADd5e2Ba62B2f6747E5CFC43e36D5005
 * Сеть: Binance Smart Chain (BSC)
 */

export const C4C_GAME_ABI = [
  {
    "inputs": [
  ...
  },
  {
    ...
    "inputs": [
      ...
      { "indexed": false, "internalType": "uint256", "name": "timeLimit", "type": "uint256" }
    ],
    "name": "GameCreated",
    "type": "event"
  },
  ...
  },
  {
    ...
    "outputs": [
      ...
      { "internalType": "bool", "name": "challengerPaid", "type": "bool" },
      { "internalType": "address", "name": "winner", "type": "address" },
      { "internalType": "bool", "name": "isDraw", "type": "bool" },
